...
Examples:
  ...
  python scripts/sync_artifacts.py import --workspace "~/GaokaoPolitics/beijing-politics-sync" --skill-root ~/.codex/skills/beijing-gaokao-politics-rubric
"""
...
def main() -> int:
    ...
    parser.add_argument("--skill-root", required=True, help="Path to beijing-gaokao-politics-rubric")
