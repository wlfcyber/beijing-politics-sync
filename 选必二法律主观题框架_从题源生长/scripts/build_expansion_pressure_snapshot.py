#!/usr/bin/env python3
"""Create an all-question coverage snapshot after expansion-draft codebook."""
...
CODEBOOK = ROOT / "08_codebook" / "provisional_codebook_v1_expansion_draft_20260519.csv"
OPEN = ROOT / "08_codebook" / "transfer_open_container_after_expansion_20260519.csv"
OUT_CSV = ROOT / "10_framework_validation" / "framework_v1_expansion_draft_pressure_snapshot_20260519.csv"
OUT_MD = ROOT / "10_framework_validation" / "framework_v1_expansion_draft_pressure_snapshot_20260519.md"
...
def main() -> None:
    ...
    source_pending = {"CC0364_2026_通州_期末_19_1"}
    output = []
    for q in questions:
        qid = q["question_id"]
        ...
        if qid in core_by_qid:
            ...
            note = "Expansion draft has core code support; still requires full sentence pressure-test."
        ...
        elif qid in source_pending:
            status = "SOURCE_CHECK_PENDING"
            matched = "CC0364_split_required"
            note = "Giant rubric atom must be split before strong support can be counted."
    ...
    core_unique = counts["CORE_CODEBOOK_SUPPORT"]
    md = [
