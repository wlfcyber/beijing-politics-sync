...
- primary_fulltext_ready: yes
- hands_free_workflow_ready: yes
- verified_fulltext: 15/8
- usable_fulltext_inventory: 15
- public_reprint_fulltext: 0
- candidate_or_incomplete: 0
- evidence_index_sources: 15
- citation_occurrences: 50
- missing_citation_sources: 0
- body_citation_occurrences: 50
- missing_page_suggestions: 0
...
当前证据满足正式研究生课程论文的默认全文数量与证据索引门槛。仍需按学校格式做最终人工格式确认。
