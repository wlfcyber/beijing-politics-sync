...
Current candidate is v7. Local QA reports: 74 分问, 64 同题组, 宝典核心轴 73 + 1 跨模块背景题, student-doc noise scan all 0 for 三十秒/工程/source_id/SRC_/entry_E/path/TODO/BLOCKED/E编号.

Claude Opus 4.8 returned PASS for v7 after checking the 5 blockers previously found by GPT-5.5 Pro:
- E032 海淀二模18 material/OCR structure restored.
- E045/E046 房山一模17(1)(2) restored 梁某/AI/设问/17(2) rubric; 17(2) rubric image was cropped to show 17.2 细则变通 and avoid 17(1) header confusion.
- E039 东城期末18(1) answer_points changed from material recap to legal answer points.
- E037 顺义一模19(1) removed 存在问题 and fixed 提起诉讼.
- E034 西城期末19 removed page footer and dangling 唤醒词 prompt.

Render QA: v7 DOCX rendered successfully. 汇编 137 pages, 宝典 143 pages. Compilation page 105 visually confirmed 房山17(2) rubric image no longer exposes 17(1) header.
