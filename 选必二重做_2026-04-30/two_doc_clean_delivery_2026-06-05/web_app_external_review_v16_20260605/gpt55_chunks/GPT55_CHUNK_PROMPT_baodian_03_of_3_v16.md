...
Current candidate is v16. Local QA reports:
...
- Rendered successfully: 汇编 86 pages, 宝典 94 pages.
...
v16 inherits the v10 fixes for the valid GPT-5.5 Pro web review failure from v9 compilation-01, and additionally fixes the valid GPT-5.5 Pro web review failure from v10 compilation-03:
...
v16 specifically fixes the valid Claude Opus 4.8 Max Safari web/app review failure from v11:
...
v16 also applies a post-Claude cleanup pass for small nonblocking OCR/text defects:
...
v16 additionally fixes the valid GPT-5.5 Pro web/app v13 compilation-01 concerns around screenshot spillover and answer-point residue:
