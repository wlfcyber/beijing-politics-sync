...
做题先定 A 轴法律关系，再定 B 轴答案形状；不先抄材料，也不先背术语。

### B轴设问决策表

| B轴 | 题眼 | 骨架 | 起手式 |
| --- | --- | --- | --- |
| B1 表格补链 | 表格、补空、链条 | 先定位空格所问，再用材料事实+法律规则+结论补齐。 | 本空应填...，理由是... |
| B2 判责理由 | 谁担责、能否支持、判决理由 | 关系/权利定位 -> 要件 -> 材料事实 -> 责任结论。 | 本案中...构成...，应... |
| B3 诉求文书 | 起诉状、诉求是否支持 | 诉讼请求 + 事实根据 + 法律理由，少写口号。 | 请求判令...，事实和理由如下... |
| B4 评析认识 | 评析、谈认识、辨析观点 | 先定性，再说理，最后落价值或法治意义。 | 该行为/判决...，因为... |
| B5 意义价值 | 意义、作用、价值 | 个人/主体 -> 市场或社会 -> 国家法治，逐层展开。 | 有利于...，也有利于... |
| B6 维权路径 | 怎么办、如何维权 | 路径 + 证据 + 请求或责任方式，避免空泛建议。 | 可通过...方式，主张...责任。 |
| B7 短答识别 | 概念、名称、短句填空 | 叫准概念，给出边界，不展开成长篇论证。 | 应填写...，不是... |

### 效力三态速查

| 类型 | 常见触发 | 答题结论 |
| --- | --- | --- |
| 效力待定 | 限制民事行为能力人超出年龄、智力相适应范围实施的民事法律行为 | 需法定代理人追认；拒绝追认后，对该限制民事行为能力人不发生效力。 |
| 可撤销 | 欺诈、胁迫、重大误解、显失公平等 | 撤销前有效；被依法撤销后，自始没有法律约束力。 |
| 无效 | 违反法律、行政法规强制性规定，违背公序良俗，恶意串通等 | 自始无效，不能用“待追认”处理。 |

### 侵权归责速查

| 路径 | 典型题眼 | 答题口径 |
| --- | --- | --- |
| 一般过错责任 | 普通侵权、好意同乘中的驾驶注意义务 | 写加害行为、损害事实、因果关系、过错；好意同乘还要看故意或重大过失与减责。 |
| 过错推定 | 建筑物、构筑物或者其他设施及其搁置物、悬挂物脱落、坠落致害 | 受害人证明损害和因果关系后，由所有人、管理人或使用人证明自己没有过错。 |
| 无过错责任 | 产品缺陷、动物致害等法定情形 | 受害人可依法向生产者或销售者主张；销售者对外不能简单写成一般过错侵权。 |

### 惩罚性赔偿倍数速查

| 场景 | 倍数/金额 | 容易误写处 |
| --- | --- | --- |
| 食品安全 | 价款十倍或者损失三倍；增加赔偿金额不足一千元的为一千元 | 先判断是否属于食品安全法路径，不与一般消费欺诈三倍混写。 |
| 一般消费欺诈 | 价款或服务费用三倍；不足五百元按五百元 | 机票搭售、隐藏收费等通常走消保法第五十五条。 |
| 约定假一赔十 | 优先看经营者承诺或双方约定 | 有明确承诺时先按约定处理，再看法定最低保护。 |
...
- 必背句：侵权题按四件套写：加害行为、损害事实、因果关系、过错；产品责任等无过错责任从其规定。
...
- 必背句：生活消费题先看知情、公平、安全和欺诈；赔偿倍数先区分食品安全十倍、一般消费欺诈三倍、约定从约定。
