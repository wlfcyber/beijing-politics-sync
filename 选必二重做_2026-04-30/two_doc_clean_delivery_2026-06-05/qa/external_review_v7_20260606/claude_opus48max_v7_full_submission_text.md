...
##### 原题图
![原题图1](qa/source_image_assets/2026_延庆_一模_第18题第1问_question_1.jpg)
...
名词解释：利用 AI 仿冒公众人物直播营销，是指借助深度合成、语音合成、形象模拟等 AI 技术，在未经授权的情况下，擅自对公众人物的外貌、声音、行为等特征进行高精度模拟，生成与该公众人物高度仿真的虚拟数字人，进而开展直播营销活动，其目的是利用公众人物的社会声誉、粉丝信任关系实现商业流量的不当攫取。
...
- 只写更换或拆除设备、只写清除云存储信息、只建议改用基础安防设备，均不能完整回应本题要求
...
##### 答题要点
- 甲公司创作虚拟数字人Ada，对其享有著作权；只笼统写合法权益、知识产权或财产权不如直接写著作权稳妥，写成专利权不符合本题
...
- 可写彰显法律权威或司法权威，作为替换角度
- 法治国家、法治社会角度要有铺垫，落到法治信仰或依法行动；不能空泛写法治中国建设，要落到法治信仰或依法行动
...
- 分析要覆盖时代背景、男女个体、科学立法或从中国实际出发，不能只罗列结论
