...
- Next: OCR or visually inspect the 21 remaining `ocr-needed` rows in `SOURCE_LEDGER.csv`, prioritizing rubric/marking-report files over papers.
- Next: process choice questions separately with reliable answer keys and write wrong-option patterns only after objective keys are verified.
- Next: after OCR and choice-question pass, rerun governor and only then consider marking STEP_03 onward complete.
