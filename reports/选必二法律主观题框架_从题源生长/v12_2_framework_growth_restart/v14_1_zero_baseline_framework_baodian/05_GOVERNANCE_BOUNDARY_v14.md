...
- 框架正文：`01_先背这套_法律主观题不扣分框架_v14.md`
- 42 题逐题拆解：`02_42题按框架拆解与解析_v14.md`
- 合并学生宝典：`选必二法律与生活_法律宝典_v14_零基础框架学习版.md`
- Confucius 学生 agent 规则和随机盲测包：`confucius_zero_baseline_student_agent/`
- 追踪矩阵：`traceability/TRACEABILITY_MATRIX_v14.csv`
...
- v14.1 can be used as a candidate classroom artifact, but final governance PASS requires real external gates or an explicit user waiver.
