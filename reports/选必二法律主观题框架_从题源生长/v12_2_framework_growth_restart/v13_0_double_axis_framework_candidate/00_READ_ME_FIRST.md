...
- `01_双轴法律主观题框架章.md`：A 轴法律关系/内容 + B 轴设问动作/命题路径。
- `02_42题双轴重标与解析宝典.md`：42 道 locked core 主观题逐题重标和解析。
- `03_AxB交叉矩阵与支持度.md`：A 轴、B 轴、A x B 支持数量和治理说明。
- `04_开放容器与不晋升题附录.md`：参考题和下一版回填候选，全部不晋升正文。
...
先看 A 轴判断题目涉及哪类法律关系，再看 B 轴判断命题人让你做什么动作。答案只允许从材料事实、法律关系、规则要件和设问动作中生长，意义价值必须挂在具体权利、义务、责任或程序上。
