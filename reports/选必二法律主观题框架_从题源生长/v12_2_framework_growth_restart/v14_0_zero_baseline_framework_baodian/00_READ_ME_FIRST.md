...
- 42 题来自 v13.10 锁定核心 traceability matrix，共 42 题。
- v14 是 Codex 本地框架重建和学生 agent 准备，不冒充新的 GPT/Claude 输出。
