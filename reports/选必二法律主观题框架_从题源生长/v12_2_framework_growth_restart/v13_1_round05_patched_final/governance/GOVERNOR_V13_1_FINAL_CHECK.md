...
This means Markdown, traceability CSV, DOCX, HTML, PDF, and PDF page-render QA exist. It does not mean DOCX direct visual-render QA passed, because this Windows host lacks LibreOffice/soffice.
