# GPT Round 03 Source-Check Review Payload

You are GPT-5.5 Pro in the Xuanbier legal-subjective-question framework council.

Task: review Codex's post-Round-01 source check. Do not rewrite the whole framework. Decide whether the source-check corrections require any structural change to the six student entrances, or whether they only tighten boundaries.
...
## Non-Promotable Items

List rows that must remain outside core.
