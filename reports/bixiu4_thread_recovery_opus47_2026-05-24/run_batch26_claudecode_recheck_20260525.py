...
PROMPT = ROOT / "OPUS47_CLAUDECODE_BATCH26_2025_XICHENG_FINAL_RECHECK_PROMPT.md"
RAW = ROOT / "OPUS47_CLAUDECODE_BATCH26_2025_XICHENG_FINAL_RECHECK_RAW.json"
STDERR = ROOT / "OPUS47_CLAUDECODE_BATCH26_2025_XICHENG_FINAL_RECHECK_STDERR.log"
DEBUG = ROOT / "OPUS47_CLAUDECODE_BATCH26_2025_XICHENG_FINAL_RECHECK_DEBUG.log"
EVIDENCE = ROOT / "OPUS47_CLAUDECODE_BATCH26_2025_XICHENG_FINAL_RUNTIME_EVIDENCE.json"
RESULT = ROOT / "OPUS47_CLAUDECODE_BATCH26_2025_XICHENG_FINAL_RECHECK_RESULT.md"
...
BATCH_REPORT = ROOT / "COVERAGE_FUSION_BATCH26_2025_XICHENG_FINAL_CODEX_20260525.md"
...
def replace_batch_report(content: str, final_status: str, evidence: dict, content_result: str, local_policy: str) -> str:
    ...
    content = content.replace("Render QA is pending because Batch26 modified the DOCX.", "Render QA passed after Batch26 DOCX modification.")
...
"""
    for path in [THREAD_STATUS, GOVERNOR, CONFUCIUS]:
        ...
        text = text.replace("LOCAL_APPLIED_RENDER_PENDING_MODEL_PENDING", final_status)
        ...
        marker = "\n## Batch26 ClaudeCode Opus 4.7 Recheck"
        if marker in text:
...
"""
    ...
    if GLOBAL_AUDIT.exists():
        ...
        text = text.replace(
            "Batch26 matrix/DOCX/render pass; ClaudeCode Opus 4.7 model-lane recheck pending.",
            f"Batch26 matrix/DOCX/render pass; ClaudeCode content_result={content_result}; model gate remains BLOCKED_MODEL_CONFIRMATION_REQUIRED.",
        )
