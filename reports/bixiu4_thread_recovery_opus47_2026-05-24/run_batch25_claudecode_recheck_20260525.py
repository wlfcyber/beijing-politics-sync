...
PROMPT = ROOT / "OPUS47_CLAUDECODE_BATCH25_2025_HAIDIAN_FINAL_RECHECK_PROMPT.md"
RAW = ROOT / "OPUS47_CLAUDECODE_BATCH25_2025_HAIDIAN_FINAL_RECHECK_STREAM_RAW_UTF8.jsonl"
STDERR = ROOT / "OPUS47_CLAUDECODE_BATCH25_2025_HAIDIAN_FINAL_RECHECK_STREAM_UTF8_STDERR.log"
DEBUG = ROOT / "OPUS47_CLAUDECODE_BATCH25_2025_HAIDIAN_FINAL_RECHECK_STREAM_UTF8_DEBUG.log"
EVIDENCE = ROOT / "OPUS47_CLAUDECODE_BATCH25_2025_HAIDIAN_FINAL_RUNTIME_EVIDENCE.json"
RESULT = ROOT / "OPUS47_CLAUDECODE_BATCH25_2025_HAIDIAN_FINAL_RECHECK_RESULT.md"
...
def parse_stream(raw_bytes: bytes, debug_text: str) -> dict:
    ...
    if isinstance(result_obj, dict):
        summary = {
            ...
            for key in ["type", "subtype", "duration_ms", "duration_api_ms", "is_error", "num_turns", "session_id"]
...
## Batch25 ClaudeCode Opus 4.7 Recheck: 2025海淀期末
Updated: 2026-05-25
...
- Result artifact: `OPUS47_CLAUDECODE_BATCH25_2025_HAIDIAN_FINAL_RECHECK_RESULT.md`.
"""
...
- Superseded by `OPUS47_BATCH25_HAIDIAN_FINAL_RECHECK_001`.
...
"""
    ...
    report = report.replace("Status: `LOCAL_APPLIED_RENDER_PASS_MODEL_PENDING`", f"Status: `{final_status}`")
