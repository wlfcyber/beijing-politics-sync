...
r32.PROMPT = r32.ROOT / "OPUS47_CLAUDECODE_BATCH33_2026_XICHENG_FINAL_RECHECK_PROMPT.md"
r32.RAW = r32.ROOT / "OPUS47_CLAUDECODE_BATCH33_2026_XICHENG_FINAL_RECHECK_RAW.json"
r32.STDERR = r32.ROOT / "OPUS47_CLAUDECODE_BATCH33_2026_XICHENG_FINAL_RECHECK_STDERR.log"
r32.DEBUG = r32.ROOT / "OPUS47_CLAUDECODE_BATCH33_2026_XICHENG_FINAL_RECHECK_DEBUG.log"
r32.EVIDENCE = r32.ROOT / "OPUS47_CLAUDECODE_BATCH33_2026_XICHENG_FINAL_RUNTIME_EVIDENCE.json"
r32.RESULT = r32.ROOT / "OPUS47_CLAUDECODE_BATCH33_2026_XICHENG_FINAL_RECHECK_RESULT.md"
r32.BATCH_REPORT = r32.ROOT / "COVERAGE_FUSION_BATCH33_2026_XICHENG_FINAL_CODEX_20260525.md"

BATCH_LABEL = "Batch33"
SUITE = "2026西城期末"
PENDING_MARKER = "CLAUDECODE_BATCH33_XICHENG_FINAL_RECHECK"
OPUS_MARKER = "OPUS47_BATCH33_XICHENG_FINAL_RECHECK_001"
...
def replace_batch_report(content: str, final_status: str, evidence: dict, content_result: str, local_policy: str) -> str:
    ...
    content = content.replace("Render QA is pending because Batch33 modified the DOCX.", "Render QA passed after Batch33 DOCX modification.")
...
"""
    for path in [r32.THREAD_STATUS, r32.GOVERNOR, r32.CONFUCIUS]:
        ...
        marker = "\n## Batch33 ClaudeCode Opus 4.7 Recheck"
        if marker in text:
...
"""
    ...
    if r32.GLOBAL_AUDIT.exists():
        ...
        text = text.replace("Batch33 matrix/DOCX/render pass; ClaudeCode Opus 4.7 model-lane recheck pending.", f"Batch33 matrix/DOCX/render pass; ClaudeCode content_result={content_result}; model gate remains BLOCKED_MODEL_CONFIRMATION_REQUIRED.")
...
def write_blocked_result(started: str, finished: str, return_code: int, stderr_text: str, raw_text: str) -> int:
    ...
    r32.RESULT.write_text(f"""# ClaudeCode Opus 4.7 Recheck Result - Batch33 2026西城期末
