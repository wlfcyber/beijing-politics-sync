# Batch QA - batch02_output_repair
...
- `claudecode_lane\batches\batch02_output_repair\entries\batch02_entries.jsonl`: rows=32, bad_json=0, missing_required=0, types={'main_thinking': 20, 'choice_trap': 12}
