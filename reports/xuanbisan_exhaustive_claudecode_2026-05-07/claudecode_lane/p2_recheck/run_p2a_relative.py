...
PROMPT = TASK_DIR / "CLAUDECODE_P2A_RELATIVE_PROMPT.md"
STDOUT = TASK_DIR / "claudecode_p2a_relative_stdout.log"
STDERR = TASK_DIR / "claudecode_p2a_relative_stderr.log"
RET = TASK_DIR / "claudecode_p2a_relative_return_code.txt"
