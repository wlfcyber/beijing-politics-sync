# ClaudeCode P2G040 P2 Source Group Recheck
...
1. `P2G040_RECHECK_DECISIONS.csv`
2. `P2G040_RECHECK_PATCHES.jsonl`
3. `P2G040_SOURCE_EVIDENCE.md`
4. `P2G040_RECHECK_ACCEPTANCE.md`
...
- There must be exactly 8 decision rows.
...
- If answer evidence is unavailable, mark `source_insufficient` and
  `can_enter_fusion=no`.
- Acceptance must state `P2G040_RECHECK_ACCEPTANCE: NOT_FINAL`, exact row
  count 8, patch count 8, no Word/PDF/delivery.

Begin by writing `P2G040_RECHECK_DECISIONS.csv`.
