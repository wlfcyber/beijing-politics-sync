# ClaudeCode P2G003 P2 Source Group Recheck
...
1. `P2G003_RECHECK_DECISIONS.csv`
2. `P2G003_RECHECK_PATCHES.jsonl`
3. `P2G003_SOURCE_EVIDENCE.md`
4. `P2G003_RECHECK_ACCEPTANCE.md`
5. `P2G003_PROGRESS.md`
...
- There must be exactly 5 decision rows.
...
- If answer evidence is unavailable, mark `source_insufficient` and
  `can_enter_fusion=no`.
- Acceptance must state `P2G003_RECHECK_ACCEPTANCE: NOT_FINAL`, exact row
  count 5, patch count 5, no Word/PDF/delivery.

Begin by writing `P2G003_RECHECK_DECISIONS.csv`.
