...
TASK_DIR = RUN_DIR / "claudecode_lane" / "p0_recheck"
PROMPT = TASK_DIR / "CLAUDECODE_P0_RECHECK_PROMPT.md"
STDOUT = TASK_DIR / "claudecode_p0_recheck_stdout.log"
STDERR = TASK_DIR / "claudecode_p0_recheck_stderr.log"
RET = TASK_DIR / "claudecode_p0_recheck_return_code.txt"
