...
BATCH_DIR = Path(r"C:\Users\Administrator\Desktop\飞哥的政治庄园\reports\选必三_穷尽性重审_ClaudeCode厚内容_2026-05-07\claudecode_lane\batches\batch04_fengtai_shunyi_tongzhou")
PROMPT = BATCH_DIR / "CLAUDECODE_BATCH04_PROMPT.md"
STDOUT = BATCH_DIR / "claudecode_batch04_stdout.log"
STDERR = BATCH_DIR / "claudecode_batch04_stderr.log"
RET = BATCH_DIR / "claudecode_batch04_return_code.txt"
