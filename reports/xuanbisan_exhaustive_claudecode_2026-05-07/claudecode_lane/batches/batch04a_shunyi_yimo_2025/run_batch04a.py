...
BATCH_DIR = Path(r"C:\Users\Administrator\Desktop\飞哥的政治庄园\reports\选必三_穷尽性重审_ClaudeCode厚内容_2026-05-07\claudecode_lane\batches\batch04a_shunyi_yimo_2025")
PROMPT = BATCH_DIR / "CLAUDECODE_BATCH04A_PROMPT.md"
STDOUT = BATCH_DIR / "claudecode_batch04a_stdout.log"
STDERR = BATCH_DIR / "claudecode_batch04a_stderr.log"
RET = BATCH_DIR / "claudecode_batch04a_return_code.txt"
