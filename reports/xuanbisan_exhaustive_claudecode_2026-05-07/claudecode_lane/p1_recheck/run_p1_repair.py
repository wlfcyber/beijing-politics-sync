...
PROMPT = TASK_DIR / "CLAUDECODE_P1_REPAIR_PROMPT.md"
STDOUT = TASK_DIR / "claudecode_p1_repair_stdout.log"
STDERR = TASK_DIR / "claudecode_p1_repair_stderr.log"
RET = TASK_DIR / "claudecode_p1_repair_return_code.txt"
