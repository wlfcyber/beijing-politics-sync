...
| 2026-06-03 | User found 2025东城一模Q20 同题组 did not match formal rubric | 同题组 must be generated and audited against formal rubric/marking-rule layers, not against the union of same-question handbook entries or six-bucket framework placements. Reference-answer summaries and expression variants cannot stand in for full 同题组. | For each edited 同题组, compare display lines with the source card's formal rubric layers; the old peer-union 同题组 audit is no longer sufficient. | feige-politics-garden-xuanbiyi current-user-requirements.md, round35_samegroup_rubric_relock/* | accepted |
