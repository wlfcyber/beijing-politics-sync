...
2. 不声称全书完成；本次只复核 slice 004 的 5 个条目（doc_order 16-20）。
...
6. 不把自己推理当作源证据。
7. 延续 slice 001-003 的已确认问题：缺独立【术语】和【细则位置】属于结构性风险，但仍需逐条判断是否还有内容级问题、证据层级问题、模块边界问题、同题组问题、内部计分问题或跨桶重复问题。
8. 特别参考 slice 003 的合并结论：ClaudeCode 原始判断可以被 Codex 用正式源证据校正；本次如发现教材/细则冲突，必须先回查可见正式源或明确写成“待回源核对”，不要把自身推理当成定论。
...
- `/Users/wanglifei/Desktop/北京高考政治/reports/选必一宝典_桌面原文件逐字逐题复核_20260617_151852/03_audit/slice_003_codex_claudecode_merge.md`
- `/Users/wanglifei/Desktop/北京高考政治/reports/选必一宝典_桌面原文件逐字逐题复核_20260617_151852/04_claudecode/slice_004_input.md`

输出要求：

把复核结论写入：

`/Users/wanglifei/Desktop/北京高考政治/reports/选必一宝典_桌面原文件逐字逐题复核_20260617_151852/04_claudecode/slice_004_claudecode_findings.md`
