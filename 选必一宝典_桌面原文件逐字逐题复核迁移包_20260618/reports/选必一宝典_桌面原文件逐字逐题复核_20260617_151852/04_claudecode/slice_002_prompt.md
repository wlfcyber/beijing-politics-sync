...
2. 不声称全书完成；本次只复核 slice 002 的 5 个条目（doc_order 6-10）。
...
6. 不把自己推理当作源证据。
7. 延续 slice 001 的已确认问题：缺独立【术语】和【细则位置】属于结构性风险，但仍需逐条判断是否还有内容级问题、证据层级问题、模块边界问题或同题组问题。
...
- `/Users/wanglifei/Desktop/北京高考政治/reports/选必一宝典_桌面原文件逐字逐题复核_20260617_151852/04_claudecode/slice_002_input.md`

输出要求：

把复核结论写入：

`/Users/wanglifei/Desktop/北京高考政治/reports/选必一宝典_桌面原文件逐字逐题复核_20260617_151852/04_claudecode/slice_002_claudecode_findings.md`
