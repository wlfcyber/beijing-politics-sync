...
- No real external GPT/Claude review was run in this v24 pass.

TASK_COMPLETE_WITH_2_MANUAL_SOURCE_DEFECTS
...
【这道题考什么】 考充分条件假言推理的边界。抓手是：只要是全民阅读设施管理单位，就应当考虑老年人阅读需求和特点，提供适老阅读内容和便利服务。
...
【怎么想到的】 题干先给出“只要是A，就应当B”，再从“某实体书店做到了B”推出“它是A”。这正是把充分条件假言判断的后件当成前件的典型错误。

【满分作答示范】 该推理是充分条件式倒推，不能成立。法规说的是全民阅读设施管理单位负有适老服务义务；实体书店做到了这项服务，只能说明具备服务表现，不能据此认定其身份就是管理单位。

【采分点对照】
- 该推理属于充分条件假言推理，推理错误
- 题干只说明“全民阅读设施管理单位”应当提供适老阅读内容和便利服务，即前件能够推出后件
- 某实体书店满足了适老服务这一后件，只能说明它具有相关服务表现，不能倒推出它必然就是全民阅读设施管理单位
...
【这道题考什么】 考概念、定义或划分规则。抓手是：界定“生产性服务业”：属概念为服务行业，种差为促进技术进步、提高生产效率、保障工农业生产活动有序进行。
...
【怎么想到的】 设问限定“明确概念内涵的方法”，材料又直接在界定“生产性服务业”。先找属概念：它被归入“服务行业”。

【满分作答示范】 材料用“种差+属概念”界定生产性服务业：先把它归入服务行业，再以推动技术进步、提升效率、保障工农业有序运转等作区别性特征，并排除直接面向消费者的独立服务。

【采分点对照】
- 材料用种差加属概念的方法界定生产性服务业，把它归入“服务行业”，并用促进技术进步、提高生产效率、保障工农业生产活动有序进行作为种差
- 同时说明其与制造业直接相关且不向消费者提供直接独立服务，使概念内涵更清晰
...
【这道题考什么】 考选言推理或复合判断。抓手是：题干把备选情况设置成不能同时成立的两个选言支，并且材料已经排除了其中一个支项。
...
【怎么想到的】 写一个能保证结论成立的演绎推理时，可以把“外贸进出口影响国内大循环”和“外贸进出口是拉动经济增长的重要引擎”设置为不能同时取舍的两个选言支。当前一支被否定时，后一支就被肯定，结论自然指向“重要引擎”。

【满分作答示范】 可写为：外贸进出口或者影响国内大循环，或者是经济增长的重要引擎；现在否定前一支；因此肯定后一支。该推理采用不相容选言推理的否定肯定式，结论能够成立。

【采分点对照】
- 外贸进出口要么影响国内大循环，要么是拉动经济增长的重要引擎
- 外贸进出口不影响国内大循环
- 外贸进出口是拉动经济增长的重要引擎
- 该推理通过否定不相容选言判断的一个支项，肯定另一个支项，能够保证结论成立
