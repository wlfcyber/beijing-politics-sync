# PHILOSOPHY ALIGNMENT V25 DOCX/PDF QA
...
- Contact sheet: `08_visual_qa/V25B_STUDENT_LANGUAGE_FINAL_CONTACT_SHEET_20260526.png`
...
Watermark count is measured across Word XML parts and appears in `word/header1.xml`.

## Text Gate

PDF scan found 0 hits for:

`卷面 / 应点出 / 可以补为 / 应补足 / 正式答案 / 候选 / 后台 / 待回源 / real_call_pending / blocked_advisor / P1_REVISE / 完整题干 / 完整选项 / 正确理由 / 诱人错项和错因 / 中项最好 / 要让结论 / 不能只说 / 可写成`

## Visual QA

QuickLook rendered sampled pages into a contact sheet:
...
This Mac does not have LibreOffice/`soffice`, so the Documents-skill full DOCX render route could not be used. PDF export was performed through Microsoft Word, then sampled visually from the exported PDFs.
